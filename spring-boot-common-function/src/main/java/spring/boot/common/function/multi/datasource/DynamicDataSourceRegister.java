...
import spring.boot.common.function.multi.datasource.config.DynamicRoutingDataSource;
...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private static final String DEFAULT = DynamicDataSourceContextHolder.DEFAULT_SOURCE;
    /**
